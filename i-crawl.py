from src.database_urls.crawlers.crawley_world_energy import world_energy_crawler
from src.database_urls.crawlers.crawley_pv_magazine import pv_magazine_crawler
from src.database_urls.crawlers.crawley_pv_tech import pv_tech_crawler
from src.database_urls.crawlers.crawley_renewsBiz import renews_biz_crawler
from src.database_urls.crawlers.crawley_offshorewindbiz import offshorewindBiz_crawler
from src.database_urls.crawlers.crawley_electrive import electrive_crawler
from src.database_urls.crawlers.crawley_power_technology import power_technology_crawler
from src.config.config_crawl import WORLD_ENERGY_CHANNELS, PV_MAGAZINE_EXTENSIONS, RENEWS_BIZ_TECH_DICT, ELECTRIVE_PAGE_TYPES
